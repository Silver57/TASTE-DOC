...
\paragraph{Ideation.} AI assistants were used as a sounding board for the framing of the cold-start problem in \cref{sec:intro}, the structure of the sweep grid in \cref{sec:design}, and the business-case narrative in \cref{sec:business}. None of the analytical conclusions in those sections was adopted from an assistant's output verbatim: each was either re-derived from the experimental results or supported by a cited source.
